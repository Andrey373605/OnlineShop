...
class AuthTokenService:
    ...
    async def rotate_refresh_token(
        self, uow: SqlUnitOfWork, old_token_id, user: UserOut, new_session_id: str
    ):
    ...
    @staticmethod
    async def get_refresh_session_or_unauthorized(uow: SqlUnitOfWork, refresh_token: str) -> Any:
        token_hash = hash_token(refresh_token)
    ...
    async def get_user_for_refresh(
        uow: SqlUnitOfWork, user_id: int, token_data: dict[str, Any]
    ) -> UserOut:
    ...
    @staticmethod
    async def revoke_refresh_token(uow: SqlUnitOfWork, refresh_token: str) -> None:
        token_hash = hash_token(refresh_token)

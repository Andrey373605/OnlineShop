...
from depricated.services.product_specification_service import (
...
async def create_product_specification(
    ...
    await event_log_service.log_event(
        ...
        description=f"Specification #{response.id} " f"created for product #{data.product_id}",
        request=request,
    )
    return response
...
async def delete_product_specification(
    ...
    await event_log_service.log_event(
        ...
        user_id=current_user.id,
        description=f"Specification #{specification_id} " f"deleted by {current_user.username}",
        request=request,
    )
    return response

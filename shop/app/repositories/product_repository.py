...
class ProductRepositorySql:
    ...
    async def get_by_id(self, product_id: int) -> ProductOut | None:
        ...
        row = await self._queries.get_product_by_id(
            self._conn,
            id=product_id
        )
    ...
    async def create(self, product_data: dict) -> int:
        ...
        result = await self._queries.create_product(
            self._conn,
            **product_data
        )
        return result['id']
    ...
    async def delete(self, product_id: int) -> bool:
        ...
        result = await self._queries.delete_product(
            self._conn,
            id=product_id
        )
        return bool(result)
    ...
    async def exists_product_with_id(self, product_id: int) -> bool:
        ...
        result = await self._queries.check_product_id_exists(
            self._conn,
            id=product_id
        )
